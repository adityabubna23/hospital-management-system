            ...
            <p>
              <input className="bg-gray-50"
                onChange={(e) =>
                  setUserData((prev) => ({
                    ...prev,
                    adress: { ...prev.address, line1: e.target.value },
                  }))
                }
              ...
              <input className="bg-gray-50"
                onChange={(e) =>
                  setUserData((prev) => ({
                    ...prev,
                    adress: { ...prev.address, line2: e.target.value },
                  }))
                }
